...
def create_train_data():
    ...
    for image_name in list(images):
        ...
        if i % 100 == 0:
            print('Training Done: {0}/{1} images'.format(i, total))
        i += 1
    print('Loading done.')
...
def create_test_data():
    ...
    for image_name in images:
        ...
        if i % 100 == 0:
            print('Test Done: {0}/{1} images'.format(i, total))
        i += 1
    print('Loading done.')
